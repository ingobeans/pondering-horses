...
const PHRASES = [
    ...
    [["screw u", "fuck u", "i hate u", "u suck", "u lame", "u are shit", "idiot", "idot", "u are lame", "u are so lame", "u are ass", "u are so ass"], ["hey!! why so rude! im just frogging my best here! >:("]],
    [["thanks", "tysm"], ["no problem! you so cool!!"]],
    [["me too", "same"], ["mm"]],
    [["im sorry", "i am sorry"], ["earnest apologies can never be rejected :)"]],
